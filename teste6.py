...
class Grafo:
    ...
    def animar_rota(self, ambulancia, hospitais, caminho, tempo_total):
        ...
        extensao = [-1, 7, -3, 3]  # Ajuste conforme a imagem e o grafo
        ...
        def desenhar_mapa():
            ...
            nx.draw(G, pos, with_labels=True, node_color=cor_nos, node_size=800, ax=ax, zorder=1)
        ...
        # A animação começa após a contagem regressiva
